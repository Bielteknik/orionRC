// Fix: Use aliased imports for Request and Response to avoid conflicts with global DOM types.
...
// 2. Static file serving for uploads and frontend assets
...
// 3. SPA Fallback: All other GET requests not handled by the API or static assets
// should serve the frontend's index.html for client-side routing.
