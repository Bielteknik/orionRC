...
// Fix: Use fully qualified express types (e.g., `express.Request`) to resolve type conflicts with global DOM types.
import express from 'express';
// Note: We don't import `Request`, `Response`, `NextFunction` as named imports to avoid conflicts.
