...
// We resolve from the current directory (.../backend/dist), go up two levels to the project root,
// and then into the 'dist' (for frontend) and 'uploads' folders.
...
const authenticateDevice = (req: express.Request, res: express.Response, next: NextFunction) => {
