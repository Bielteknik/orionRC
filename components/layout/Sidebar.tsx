...
import { DashboardIcon, StationIcon, SensorIcon, CameraIcon, DefinitionsIcon, ReportsIcon, CloudIcon } from '../icons/Icons';
  ...
  return (
    <div className="w-64 bg-primary dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col">
      <div className="flex items-center justify-center h-20 border-b border-gray-200 dark:border-gray-700">
        ...
        <h1 className="text-xl font-bold ml-2 text-gray-900 dark:text-gray-100">METEO</h1>
      </div>
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700">
        <p className="text-xs text-muted dark:text-gray-400 text-center">© 2024 Meteoroloji Platformu</p>
      </div>
    </div>
  );
};
